...
bool test_iter_create_with_failed_malloc() {
  ...
  set_malloc_status(true);
  tests_result &=
      test_assert("El iterador en head no fue creado", iter == NULL);
  tests_result &=
      test_assert("El iterador en tail no fue creado", iter2 == NULL);
  list_destroy(list, NULL);
  return tests_result;
}
...
bool test_iter_simple_move() {
  ...
  *aux = 2;
  ...
  tests_result &= test_assert("El iterador en head fue creado", iter != NULL);
  tests_result &=
      test_assert("El iterador en head avanzo", list_iter_forward(iter));
  tests_result &= test_assert("El iterador en head no puede volver a avanzar",
                              !list_iter_forward(iter));
  tests_result &=
      test_assert("El iterador en head retrocedio", list_iter_backward(iter));
  tests_result &=
...
bool test_iter_move_at_start_and_end() {
  ...
  *aux = 2;
  ...
  tests_result &= test_assert("El iterador en head fue creado", iter != NULL);
  tests_result &=
      test_assert("El iterador esta al principio", list_iter_at_first(iter));
  tests_result &=
      test_assert("El iterador no esta al final", !list_iter_at_last(iter));
  tests_result &=
      test_assert("El iterador en head avanzo", list_iter_forward(iter));
  tests_result &= test_assert("El iterador no esta al principio",
                              !list_iter_at_first(iter));
  tests_result &=
...
bool test_iter_insert_after_at_start() {
  ...
  *aux = 2;
  tests_result &= test_assert("Se inserto un elemento delante de head",
                              list_iter_insert_after(iter, aux));
  tests_result &=
      test_assert("El iterador sigue en el primero", list_iter_at_first(iter));
  list_iter_destroy(iter);

  iter = list_iter_create_head(list);
  tests_result &=
      test_assert("Se creo un nuevo iterador al principio", iter != NULL);
  ...
  tests_result &=
      test_assert("El iterador no puede avanzar", !list_iter_forward(iter));
  list_iter_destroy(iter);
...
bool test_iter_insert_after_at_start_fails() {
  ...
  *aux = 3;
  ...
  tests_result &= test_assert("El iterador en head fue creado", iter != NULL);
  set_malloc_status(false);
  tests_result &= test_assert("Fallo insertar un elemento delante",
                              !list_iter_insert_after(iter, aux));
  set_malloc_status(true);
  tests_result &=
      test_assert("El iterador sigue en el primero", list_iter_at_first(iter));
...
bool test_iter_insert_before_at_end() {
  ...
  *aux = 2;
  tests_result &= test_assert("Se inserto un elemento atras del final",
                              list_iter_insert_before(iter, aux));
  tests_result &=
      test_assert("El iterador sigue en el final", list_iter_at_last(iter));
  list_iter_destroy(iter);
...
bool test_iter_insert_before_at_end_fails() {
  ...
  *aux = 2;
  set_malloc_status(false);
  tests_result &= test_assert("Fallo insertar un elemento atras del final",
                              !list_iter_insert_before(iter, aux));
  set_malloc_status(true);
  free(aux);
  tests_result &=
...
bool test_iter_insert_before_at_middle() {
  ...
  *aux = 4;
  ...
  tests_result &= test_assert("El iterador en head fue creado", iter != NULL);
  tests_result &=
      test_assert("El iterador retrocedio", list_iter_backward(iter));
  aux = malloc(sizeof(int));
  *aux = 2;
...
bool test_iter_insert_empty_lists() {
  ...
  *aux = 1;
  tests_result &=
      test_assert("Se inserto un 1", list_iter_insert_after(iter, aux));
  tests_result &=
      test_assert("El iterador está en el primero", list_iter_at_first(iter));
  list_iter_destroy(iter);
  aux = list_pop_head(list);
  tests_result &=
      test_assert("Se remueve el primer elemento y es un 1", *aux == 1);
  ...
  *aux = 2;
  tests_result &=
      test_assert("Se inserto un 2", list_iter_insert_after(iter, aux));
  tests_result &=
      test_assert("El iterador está en el primero", list_iter_at_first(iter));
  list_iter_destroy(iter);
  aux = list_pop_tail(list);
  ...
  *aux = 3;
  tests_result &=
      test_assert("Se inserto un 3", list_iter_insert_after(iter, aux));
  tests_result &=
      test_assert("El iterador está en el ultimo", list_iter_at_last(iter));
  list_iter_destroy(iter);
  aux = list_pop_head(list);
  tests_result &=
      test_assert("Se remueve el primer elemento y es un 3", *aux == 3);
  ...
  *aux = 4;
  tests_result &=
      test_assert("Se inserto un 4", list_iter_insert_after(iter, aux));
  tests_result &=
      test_assert("El iterador está en el ultimo", list_iter_at_last(iter));
  list_iter_destroy(iter);
  aux = list_pop_tail(list);
...
bool test_iter_delete_empty_list() {
  ...
  tests_result &= test_assert("El iterador en head fue creado", iter != NULL);
  tests_result &=
      test_assert("No hay nada para borrar", !list_iter_delete(iter));
  list_iter_destroy(iter);
...
bool test_iter_delete_one_element_list() {
  ...
  *aux = 1;
  tests_result &=
      test_assert("Se inserto un 1 en la lista", list_insert_tail(list, aux));
  ...
  tests_result &=
      test_assert("No hay nada en el principio", !list_peek_head(list));
...
bool test_iter_delete_head() {
  ...
  *aux = 2;
  tests_result &=
      test_assert("Se inserto un 2 en la lista", list_insert_tail(list, aux));
  aux = malloc(sizeof(int));
  *aux = 3;
  tests_result &=
      test_assert("Se inserto un 3 en la lista", list_insert_tail(list, aux));
  aux = malloc(sizeof(int));
  *aux = 4;
  tests_result &=
      test_assert("Se inserto un 4 en la lista", list_insert_tail(list, aux));
...
bool test_iter_delete_middle() {
  ...
  *aux = 8;
  tests_result &=
      test_assert("Se inserto un 8 en la lista", list_insert_tail(list, aux));
  aux = malloc(sizeof(int));
  *aux = 4;
  tests_result &=
      test_assert("Se inserto un 4 en la lista", list_insert_tail(list, aux));
  ...
  tests_result &= test_assert("El iterador en tail fue creado", iter != NULL);
  tests_result &=
      test_assert("Se retrocede el iterador", list_iter_backward(iter));
  aux = list_iter_delete(iter);
